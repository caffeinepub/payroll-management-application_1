    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Προσθέστε μηνιαίο μισθό τράπεζας για τον {employeeName}. Μπορείτε να προσθέσετε πολλαπλές καταχωρήσεις για τον ίδιο μήνα - το σύστημα θα τις αθροίσει αυτόματα στη μισθοδοσία.
          </DialogDescription>
        </DialogHeader>
